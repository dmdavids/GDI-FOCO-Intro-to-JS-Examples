...
// I chose to only use zipcode with radius to get smaller number
// of results note that default radius is 25.0
function meetupOpenEvents() {
    $.ajax({
        url: 'https://api.meetup.com/2/open_events',
        data: {
            "zip": '80528',
            "radius": '1.0',
            "key":'put your meetup api key here'
        },
        crossDomain: true,
        dataType: 'jsonp',
        type: "GET",
