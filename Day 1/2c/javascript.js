...
document.body.innerHTML = '<p>My site Where All the Code is in a Script file!</p>';
document.body.innerHTML += '<p><a href="#" onclick="calculate()"> Calculate life time supply </a></p>';
document.body.innerHTML += '<p><a href="#" onclick="favoriteThings()"> What are my favorite things?</a></p>';
document.body.innerHTML += '<p><a href="#" onclick="myFriends()"> Who are my friends?</a></p>';
